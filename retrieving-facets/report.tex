...
in exploratory task for digital library applications
\cite{hearst2006clustering,kules2009what}.  While being recognized as an
eminent information seeking tool, usability of faceted search remains an open
issue for researchers to work on.  Conventional faceted search presents the
discovered facets based on the number of counts.  This type of arrangement
...
ranging from 30\% to 100\% in terms of MAP.  This result confirms the validity
of our idea, indicating that a relevance-weighted model is probably more useful
than a count-based model in the facet ranking task.  
