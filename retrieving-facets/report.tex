...
The rest of the work is organized as follows.  First, we introduce a Bayesian
...
%--------------------------------------------------
% One special criteria that we adhered to is, for any facet being labeled as
% relevant to a query, we required that at least one document in the test
% collection exhibits such correspondence.  Therefore, the expert was allowed to
% use the database system to research on the query topics and looked into the
% facet statistics for making his own conclusion.
%-------------------------------------------------- 
...
%--------------------------------------------------
% To find out the best parameter setting, we also sent off multiple
