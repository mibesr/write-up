...
\f{Priors}{
  ...
  \begin{itemize}
    ...
    \item Parameterized by some constant $c$
  \end{itemize}
  ...
  \begin{itemize}
    ...
    \item Parameterized by some constant $\mu$
...
\f{Retrieving Query-Relevant Facets}{
  ...
  \begin{itemize}
    ...
    guide the subsequence exploratory search
...
\f{Query Refinement Using the Secondary Representation}{
  Facilatating the second-run retrieval
  \begin{itemize}
