...
\f{}{
  \begin{textblock}{5}(0,0)
    \begin{figure}
      ...
      \includegraphics[width=350pt]{fig/fig1}
    \end{figure}
  \end{textblock}
}
...
\f{Clustering Effect}{
  ...
  \fig{Backward Walks with $s = 0.9$}{width=250pt}{fig/fig2}
}
...
\f{Walk Parameters (cont'd)}{
  ...
  \fig{Non-Self Transitions}{width=250pt}{fig/fig3}
}
...
\f{Result: Overall Comparison}{ \fig{}{width=250pt}{fig/tbl1} }
\f{Result: Retrieved Images Per Query}{ \fig{Number of Retrieved Image vs. Distance from Query}{width=250pt}{fig/fig5} }
\f{Result: Retrieved Images Per Query (cont'd)}{ \fig{Precision vs. Distance from Query}{width=250pt}{fig/fig6} }
\f{Result: Precision-Recall Curves}{ \fig{All Walks with $s = 0$}{width=250pt}{fig/fig7} }
\f{Result: Precision-Recall Curves (cont'd)}{ \fig{Backward Walks with varying $s$}{width=250pt}{fig/fig8} }
\f{Result: Grid Search on the $t$-$s$ Plane}{ \fig{}{width=250pt}{fig/fig9} }
